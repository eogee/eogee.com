...
?>
    ...
    <tr id = "titleAbbre">
        <td></td>
        <td>
            <input type = "text" name="titleAbbre" class="layui-input" lay-verify="required">
        </td>
    </tr>
    <tr id = "titleColor">
        <td></td>
    ...
    <tr id = "newsContent">
        <td></td>
        <td>
            <input type = "text" name="newsContent" class="layui-input">
            <div class="layui-word-aux">
                用于最新动态内容，可为空
            </div>
        </td>
    ...
    <tr id = "btn1">
        <td></td>
        <td>
            <input type = "text" name="btn1" class="layui-input">
        </td>
    </tr>
    <tr id = "btn1url">
        <td></td>
        <td>
            <input type = "text" name="btn1url" class="layui-input">
        </td>
    </tr>
    <tr id = "btn1blank">
        <td></td>
    ...
    <tr id = "btn2">
        <td></td>
        <td>
            <input type = "text" name="btn2" class="layui-input">
        </td>
    </tr>
    <tr id = "btn2url">
        <td></td>
        <td>
            <input type = "text" name="btn2url" class="layui-input">
        </td>
    </tr>
    <tr id = "btn2blank">
        <td></td>
    ...
    <tr id = "newsDate">
        <td></td>
        <td>
            <input id = "newsDateInput" type = "text" name="newsDate" class="layui-input" lay-verify="date">
        </td>
    </tr>
